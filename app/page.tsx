  ...
  return (
    <div className="min-h-screen p-8 sm:p-20 font-sans">
      ...
      <main className="p-4 md:p-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8">Аналитика продаж</h1>
        <section className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-8">
              {[1, 2, 3].map((item) => (
                <div key={item} className="w-full md:flex-1 border-2 border-solid rounded-lg p-2 md:p-4">
      ...
      <div className='my-10'>
        <h1 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8">Автоматизация</h1>
